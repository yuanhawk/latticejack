...
| Demo video | **Recorded** — ~2:37, built around the live demo above rather than raw terminal commands. Production account (including two real bugs found and fixed doing it for real): [`docs/video-production/README.md`](docs/video-production/README.md). [Link to be added once uploaded to YouTube/Vimeo/Youku.] |
