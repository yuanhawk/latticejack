...
| Demo video | **Live on YouTube:** [youtu.be/q9-zN3HJJPE](https://youtu.be/q9-zN3HJJPE) — ~2:38, built around the live demo above rather than raw terminal commands. Production account (including real bugs found and fixed doing it for real, some after publishing): [`docs/video-production/README.md`](docs/video-production/README.md). |
